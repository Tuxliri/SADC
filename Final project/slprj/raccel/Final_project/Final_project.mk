...
MODEL                = Final_project
MODULES              = rt_logging.c Final_project.c Final_project_capi.c Final_project_data.c Final_project_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = Final_project.exe
...
MASTER_ANCHOR_DIR    = 
START_DIR            = G:/My Drive/Documents/1st year MSC/SC Attitude and Dynamics/Final project
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Final_project_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Final_project \
